    ...
    <Section className="flex max-md:flex-col items-start gap-4">
        ...
        <div className="flex-[2] h-full w-full gap-4 flex flex-col">
            ...
            <Card className="p-4 flex-1 flex flex-col gap-2">
                ...
                <ContactCard 
                name="My LinkedIn" 
                image="https://media.licdn.com/dms/image/D4E03AQFAFG0M_8NXmQ/profile-displayphoto-shrink_200_200/0/1715605947938?e=1721260800&v=beta&t=lsh5ftupoxk-M2yI_Kp9NM1h97PWWG57tBPacTgA-7k"
